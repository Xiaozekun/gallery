...
from gallery.blueprints.admin import admin_bp
from gallery.blueprints.ajax import ajax_bp
from gallery.blueprints.auth import auth_bp
from gallery.blueprints.main import main_bp
from gallery.blueprints.user import user_bp
from gallery.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf
from gallery.models import Role, User, Photo, Tag, Follow, Notification, Comment, Collect, Permission
from gallery.settings import config
...
def register_commands(app):
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from gallery.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, fake_collect
