...
from gallery.decorators import confirm_required, permission_required
from gallery.emails import send_change_email_email
from gallery.extensions import db, avatars
from gallery.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from gallery.models import User, Photo, Collect
from gallery.notifications import push_follow_notification
from gallery.settings import Operations
from gallery.utils import generate_token, validate_token, redirect_back, flash_errors
